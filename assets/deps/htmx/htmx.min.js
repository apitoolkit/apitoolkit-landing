(function (e, t) {
  ...
  return (function () {
    ...
    function lt(t, r, e) {
      if (
        (t.tagName === "A" && st(t) && (t.target === "" || t.target === "_self")) ||
        t.tagName === "FORM"
      ) {
        r.boosted = true;
        var n, i;
      ...
      if (!dt) {
        ...
        setInterval(function () {
          if (vt) {
            vt = false;
            oe(
              re().querySelectorAll("[hx-trigger='revealed'],[data-hx-trigger='revealed']"),
              function (e) {
                mt(e);
              }
            );
        ...
        var y = function () {
          try {
            ...
            if (t.elt && !se(t.elt) && ee(t.elt, "id")) {
              ...
              var a = {
                preventScroll:
                  v.focusScroll !== undefined ? !v.focusScroll : !Q.config.defaultFocusScroll,
              };
              if (i) {
