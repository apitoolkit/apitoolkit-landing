        ...
        <tr>
         ...
         <tr>
            ...
            <td class="border border-blue-500 bg-slate-50 dark:bg-inherit prose text-center">
                ...
                <p>Focused on API-first monitoring, observability, and application performance management (APM). Track and trace incoming and outgoing requests and capture the entire request-response chain of all endpoints on your API.</p>
            </td>
         ...
         <tr>
            ...
            <td class="border border-blue-500 bg-slate-50 dark:bg-inherit prose text-center">
                Users on any plan can <a href="https://apitoolkit.io/demo" target="_blank" rel="noopener noreferrer" class="text-slate-500">schedule a call</a> with a core engineer on the team, join our <a href="https://apitoolkit.io/discord" target="_blank" rel="noopener noreferrer" class="text-slate-500">community Discord server</a>, write to us via email, or submit issues on GitHub. Our support team is always ready to help, swiftly!
            </td>
            <td class="border prose text-center">
