          ...
          !(function (b, c) {
            ...
            function f(a) {
              return (
                ...
                (a >= 5760 &&
                  [
                    5760, 6158, 8192, 8193, 8194, 8195, 8196, 8197, 8198, 8199, 8200, 8201, 8202,
            ...
            function h(a) {
              return (
                ...
                (a >= 97 && a <= 122) ||
                92 === a ||
                (a >= 128 && eb.NonAsciiIdentifierStart.test(String.fromCharCode(a)))
              );
            }
            function i(a) {
              return (
            ...
            function n(a, c, d, e, f) {
              ...
              b("number" == typeof d, "Comment must have valid position"),
                ob.lastCommentStart >= d ||
                  ...
                  pb.loc && (g.loc = f),
                  pb.comments.push(g),
                  pb.attachComment && (pb.leadingComments.push(g), pb.trailingComments.push(g)));
            }
            function o(a) {
              var b, c, d, e;
              for (b = ib - a, c = { start: { line: jb, column: ib - kb - a } }; ib < lb; )
            ...
            function p() {
              var a, b, c, d;
              for (
                pb.comments && ((a = ib - 2), (b = { start: { line: jb, column: ib - kb - 2 } }));
                ib < lb;
            ...
            function q() {
              ...
              for (b = 0 === ib; ib < lb; )
                if (((a = gb.charCodeAt(ib)), f(a))) ++ib;
                  ...
                  ++ib, 13 === a && 10 === gb.charCodeAt(ib) && ++ib, ++jb, (kb = ib), (b = !0);
                else if (47 === a)
                  if (47 === (a = gb.charCodeAt(ib + 1))) ++ib, ++ib, o(2), (b = !0);
                  else {
                    if (42 !== a) break;
                    ++ib, ++ib, p();
                  }
            ...
            function s() {
              ...
              for (
                a = gb.charCodeAt(ib++),
                  ...
                  92 === a &&
                    (117 !== gb.charCodeAt(ib) && O({}, db.UnexpectedToken, "ILLEGAL"),
                    ++ib,
                    (a = r("u")),
                    (a && "\\" !== a && h(a.charCodeAt(0))) || O({}, db.UnexpectedToken, "ILLEGAL"),
                    (b = a));
                ...
                ++ib,
                  ...
                  92 === a &&
                    ...
                    ++ib,
                    (a = r("u")),
                    (a && "\\" !== a && i(a.charCodeAt(0))) || O({}, db.UnexpectedToken, "ILLEGAL"),
                    (b += a));
              return b;
            }
            function t() {
                    ...
                    : m(b)
                      ...
                      : "null" === b
                        ...
                        : "true" === b || "false" === b
                          ? $a.BooleanLiteral
                          : $a.Identifier),
                { type: c, value: b, lineNumber: jb, lineStart: kb, start: a, end: ib }
              );
            }
            function v() {
              var a,
                  ...
                  return (
                    ...
                    pb.tokenize &&
                      (40 === f
                        ...
                        : 123 === f && (pb.openCurlyToken = pb.tokens.length)),
                    {
                      type: $a.Punctuator,
            ...
            function B() {
              ...
              for (
                a = gb[ib],
                  b("/" === a, "Regular expression literal must start with a slash"),
                  c = gb[ib++],
                  d = !1,
                  e = !1;
                ib < lb;
                ...
                if (((a = gb[ib++]), (c += a), "\\" === a))
                  (a = gb[ib++]), g(a.charCodeAt(0)) && O({}, db.UnterminatedRegExp), (c += a);
            ...
            function D() {
              ...
              return (
                ...
                pb.tokenize
                  ...
                  : { literal: b.literal + c.literal, value: d, start: a, end: ib }
              );
            }
            function E() {
              var a, b, c, d;
            ...
            function H() {
              ...
              return (
                q(),
                ib >= lb
                  ? { type: $a.EOF, lineNumber: jb, lineStart: kb, start: ib, end: ib }
                  : ((a = gb.charCodeAt(ib)),
                    h(a)
                      ? u()
                      : 40 === a || 41 === a || 59 === a
            ...
            function I() {
              ...
              return (
                ...
                b.type !== $a.EOF &&
                  ...
                  pb.tokens.push({ type: _a[b.type], value: c, range: [b.start, b.end], loc: a })),
                b
              );
            }
            function J() {
            ...
            function N() {
              var a, b, c, d;
              return (
                (a = ib), (b = jb), (c = kb), q(), (d = jb !== b), (ib = a), (jb = b), (kb = c), d
              );
            }
            function O(a, c) {
              var d,
              ...
              return (
                ...
                a.type === $a.Identifier
                  ? ((c = $()),
                    "get" !== a.value || T(":")
                      ? "set" !== a.value || T(":")
                        ? (R(":"), (d = pa()), mb.markEnd(mb.createProperty("init", c, d), f))
                        : ((b = $()),
                          R("("),
                          (a = nb),
                          a.type !== $a.Identifier
                            ? (R(")"), P(a, db.UnexpectedToken, a.value), (d = Z([])))
                            : ((e = [ta()]), R(")"), (d = Z(e, a))),
            ...
            function aa() {
              ...
              for (e = nb, R("{"); !T("}"); )
                (a = _()),
                  (b = a.key.type === bb.Identifier ? a.key.name : h(a.key.value)),
                  (d = "init" === a.kind ? cb.Data : "get" === a.kind ? cb.Get : cb.Set),
                  (c = "$" + b),
            ...
            function ca() {
              ...
              if (((a = nb.type), (d = nb), a === $a.Identifier))
                ...
                hb && nb.octal && P(nb, db.StrictOctalLiteral), (c = mb.createLiteral(J()));
              else if (a === $a.Keyword) {
                if (U("function")) return Ta();
                U("this") ? (J(), (c = mb.createThisExpression())) : Q(J());
              } else
                a === $a.BooleanLiteral
                  ? ((b = J()), (b.value = "true" === b.value), (c = mb.createLiteral(b)))
                  : a === $a.NullLiteral
                    ? ((b = J()), (b.value = null), (c = mb.createLiteral(b)))
                    : T("/") || T("/=")
                      ? ((c = void 0 !== pb.tokens ? mb.createLiteral(E()) : mb.createLiteral(D())),
                        K())
                      : Q(J());
            ...
            function ia() {
              var a, b, c, d, e;
              for (
                e = nb, a = ob.allowIn, ob.allowIn = !0, b = U("new") ? ha() : ca(), ob.allowIn = a;
                ;
            ...
            function ka() {
              ...
              return (
                ...
                nb.type === $a.Punctuator &&
                  ((!T("++") && !T("--")) ||
                    N() ||
                    (hb && a.type === bb.Identifier && l(a.name) && P({}, db.StrictLHSPostfix),
                    X(a) || P({}, db.InvalidLHSInAssignment),
                    (b = J()),
                    (a = mb.markEnd(mb.createPostfixExpression(b.value, a), c)))),
                a
              );
            }
            function la() {
                ...
                nb.type !== $a.Punctuator && nb.type !== $a.Keyword
                  ...
                  : T("++") || T("--")
                    ? ((c = nb),
                      (a = J()),
                      (b = la()),
                      hb && b.type === bb.Identifier && l(b.name) && P({}, db.StrictLHSPrefix),
            ...
            function pa() {
              ...
              return (
                ...
                V() &&
                  (X(b) || P({}, db.InvalidLHSInAssignment),
                  hb && b.type === bb.Identifier && l(b.name) && P(a, db.StrictLHSAssignment),
                  (a = J()),
                  (c = pa()),
                  (d = mb.markEnd(mb.createAssignmentExpression(a.value, b, c), e))),
                d
              );
            }
            function qa() {
            ...
            function sa() {
              var a, b;
              return (
                (b = nb), R("{"), (a = ra()), R("}"), mb.markEnd(mb.createBlockStatement(a), b)
              );
            }
            function ta() {
              var a, b;
            ...
            function xa(a) {
              var b, c;
              return (
                (c = nb), S(a), (b = va(a)), W(), mb.markEnd(mb.createVariableDeclaration(b, a), c)
              );
            }
            function ya() {
                  ...
                  : (U("var") || U("let")
                      ...
                      : ((ob.allowIn = !1),
                        ...
                        U("in") &&
                          ...
                          (a = null))),
                    void 0 === d && R(";")),
                void 0 === d && (T(";") || (b = qa()), R(";"), T(")") || (c = qa())),
                R(")"),
                (g = ob.inIteration),
                (ob.inIteration = !0),
                (f = Pa()),
                (ob.inIteration = g),
                void 0 === d ? mb.createForStatement(a, b, c, f) : mb.createForInStatement(d, e, f)
              );
            }
            function Fa() {
              var a,
                  ...
                  : N()
                    ...
                    : (nb.type === $a.Identifier &&
                        ...
                        Object.prototype.hasOwnProperty.call(ob.labelSet, a) ||
                          O({}, db.UnknownLabel, b.name)),
                      W(),
                      null !== b || ob.inIteration || ob.inSwitch || O({}, db.IllegalBreak),
            ...
            function Ja() {
              var a,
                ...
                d = [];
              for (
                c = nb, U("default") ? (J(), (a = null)) : (S("case"), (a = qa())), R(":");
            ...
            function Ka() {
              ...
              for (d = ob.inSwitch, ob.inSwitch = !0, e = !1; ib < lb && !T("}"); )
                (c = Ja()),
                  null === c.test && (e && O({}, db.MultipleDefaultsInSwitch), (e = !0)),
                  b.push(c);
            ...
            function Ra(a) {
              ...
              if ((R("("), !T(")")))
                for (
                  ...
                  R(",");
              return R(")"), { params: h, stricted: d, firstRestricted: a, message: g };
            }
            function Sa() {
              var a,
                b,
            ...
            function Za(a, b) {
              ...
              (d = String),
                ...
                void 0 !== b &&
                  ((pb.range = "boolean" == typeof b.range && b.range),
                  (pb.loc = "boolean" == typeof b.loc && b.loc),
                  (pb.attachComment = "boolean" == typeof b.attachComment && b.attachComment),
                  pb.loc && null !== b.source && void 0 !== b.source && (pb.source = d(b.source)),
              ...
              (fb = {
                    ...
                    for (
                      pb.trailingComments.length > 0
                        ? pb.trailingComments[0].range[0] >= a.range[1]
                          ? ((c = pb.trailingComments), (pb.trailingComments = []))
                          : (pb.trailingComments.length = 0)
                        : pb.bottomRightStack.length > 0 &&
                          pb.bottomRightStack[pb.bottomRightStack.length - 1].trailingComments &&
                          pb.bottomRightStack[pb.bottomRightStack.length - 1].trailingComments[0]
                            .range[0] >= a.range[1] &&
                          ((c =
                            pb.bottomRightStack[pb.bottomRightStack.length - 1].trailingComments),
                          delete pb.bottomRightStack[pb.bottomRightStack.length - 1]
                            .trailingComments);
                      pb.bottomRightStack.length > 0 &&
                      pb.bottomRightStack[pb.bottomRightStack.length - 1].range[0] >= a.range[0];

                    )
                      b = pb.bottomRightStack.pop();
                    b
                      ? b.leadingComments &&
                        b.leadingComments[b.leadingComments.length - 1].range[1] <= a.range[0] &&
                        ((a.leadingComments = b.leadingComments), delete b.leadingComments)
                      : pb.leadingComments.length > 0 &&
                        pb.leadingComments[pb.leadingComments.length - 1].range[1] <= a.range[0] &&
                        ((a.leadingComments = pb.leadingComments), (pb.leadingComments = [])),
                ...
                markEnd: function (a, b) {
                  return (
                    ...
                    pb.loc &&
                      ((a.loc = new M(
                        void 0 === b.startLineNumber ? b.lineNumber : b.startLineNumber,
                        b.start - (void 0 === b.startLineStart ? b.lineStart : b.startLineStart),
                        jb,
                        ib - kb
                      )),
                      this.postProcess(a)),
                ...
                createAssignmentExpression: function (a, b, c) {
                  return { type: bb.AssignmentExpression, operator: a, left: b, right: c };
                },
                ...
                createConditionalExpression: function (a, b, c) {
                  return { type: bb.ConditionalExpression, test: a, consequent: b, alternate: c };
                },
                ...
                createForStatement: function (a, b, c, d) {
                  return { type: bb.ForStatement, init: a, test: b, update: c, body: d };
                },
                createForInStatement: function (a, b, c) {
                  return { type: bb.ForInStatement, left: a, right: b, body: c, each: !1 };
                },
                ...
                createIfStatement: function (a, b, c) {
                  return { type: bb.IfStatement, test: a, consequent: b, alternate: c };
                },
                createLabeledStatement: function (a, b) {
                  return { type: bb.LabeledStatement, label: a, body: b };
                },
                createLiteral: function (a) {
                  return { type: bb.Literal, value: a.value, raw: gb.slice(a.start, a.end) };
                },
                createMemberExpression: function (a, b, c) {
                  return { type: bb.MemberExpression, computed: "[" === a, object: b, property: c };
                },
                ...
                createPostfixExpression: function (a, b) {
                  return { type: bb.UpdateExpression, operator: a, argument: b, prefix: !1 };
                },
                ...
                createUnaryExpression: function (a, b) {
                  return "++" === a || "--" === a
                    ? { type: bb.UpdateExpression, operator: a, argument: b, prefix: !0 }
                    : { type: bb.UnaryExpression, operator: a, argument: b, prefix: !0 };
                },
                createVariableDeclaration: function (a, b) {
                  return { type: bb.VariableDeclaration, declarations: a, kind: b };
                },
              ...
              var b = {
                  ...
                  performAction: function (a, b, d, e, f, g, h) {
                    ...
                    switch (f) {
                      case 1:
                        return (
                          e.ast.set({ expression: { type: "root", value: g[i] } }),
                          e.ast.unshift(),
                          e.ast.yield()
                        );
                      case 2:
                        return (
                          e.ast.set({ expression: { type: "root", value: g[i - 1] } }),
                          e.ast.unshift(),
                          e.ast.yield()
                        );
                      case 3:
                      ...
                      case 4:
                        return (
                          e.ast.set({
                            operation: "member",
                            scope: "child",
                            expression: { type: "identifier", value: g[i - 1] },
                          }),
                          e.ast.unshift(),
                          e.ast.yield()
                        );
                      ...
                      case 13:
                        break;
                      case 14:
                        e.ast.set({ expression: { type: "wildcard", value: g[i] } });
                        break;
                      case 15:
                        e.ast.set({ expression: { type: "identifier", value: g[i] } });
                        break;
                      case 16:
                        e.ast.set({ expression: { type: "script_expression", value: g[i] } });
                        break;
                      case 17:
                        e.ast.set({
                          expression: { type: "numeric_literal", value: parseInt(g[i]) },
                        });
                        break;
                      case 18:
                        break;
                      ...
                      case 24:
                        g[i].length > 1
                          ? e.ast.set({ expression: { type: "union", value: g[i] } })
                          : (this.$ = g[i]);
                        break;
                      case 25:
                        this.$ = [g[i]];
                      ...
                      case 27:
                        ...
                        break;
                      case 28:
                        (this.$ = { expression: { type: "string_literal", value: g[i] } }),
                          e.ast.set(this.$);
                        break;
                      case 29:
                        (this.$ = { expression: { type: "slice", value: g[i] } }),
                          e.ast.set(this.$);
                        break;
                      case 30:
                        (this.$ = { expression: { type: "wildcard", value: g[i] } }),
                          e.ast.set(this.$);
                        break;
                      case 31:
                        (this.$ = { expression: { type: "script_expression", value: g[i] } }),
                          e.ast.set(this.$);
                        break;
                      case 32:
                        (this.$ = { expression: { type: "filter_expression", value: g[i] } }),
                          e.ast.set(this.$);
                        break;
                      case 33:
                      case 34:
                    ...
                    for (var q, r, s, t, u, v, w, x, y, z = {}; ; ) {
                      if (
                        ...
                        this.defaultActions[s]
                          ...
                          : ((null !== q && void 0 !== q) || (q = b()), (t = g[s] && g[s][q])),
                        void 0 === t || !t.length || !t[0])
                      ) {
                        var A = "";
                        y = [];
                        for (v in g[s])
                          this.terminals_[v] && v > l && y.push("'" + this.terminals_[v] + "'");
                        (A = this.lexer.showPosition
                          ...
                          : "Parse error on line " +
                            (i + 1) +
                            ": Unexpected " +
                            (q == m ? "end of input" : "'" + (this.terminals_[q] || q) + "'")),
                          this.parseError(A, {
                      ...
                      if (t[0] instanceof Array && t.length > 1)
                        throw new Error(
                          "Parse Error: multiple actions possible at state: " + s + ", token: " + q
                        );
                      switch (t[0]) {
                        case 1:
                          d.push(q),
                          ...
                          if (
                            ...
                            void 0 !==
                              (u = this.performAction.apply(
                                z,
                                [h, j, i, this.yy, t[1], e, f].concat(n)
                              )))
                          )
                            return u;
                          w &&
            ...
            f = {
              lex: {
                ...
                rules: [
                  ...
                  ["{int}", "return 'INTEGER'"],
                  [d.qq_string, "yytext = yytext.substr(1,yyleng-2); return 'QQ_STRING';"],
                  [d.q_string, "yytext = yytext.substr(1,yyleng-2); return 'Q_STRING';"],
                ...
                k = function (b, h) {
                  e(b)
                    ? (b.forEach(function (a, b) {
                        j.length >= g || (d(b, a, c) && j.push({ path: h.concat(b), value: a }));
                      }),
                    ...
                    : f(b) &&
                      (this.keys(b).forEach(function (a) {
                        j.length >= g ||
                          (d(a, b[a], c) && j.push({ path: h.concat(a), value: b[a] }));
                      }),
            ...
            (q.prototype._fns = {
              "member-child-identifier": function (a, b) {
                var c = a.expression.value,
                  d = b.value;
                if (d instanceof Object && c in d) return [{ value: d[c], path: b.path.concat(c) }];
              },
              ...
              "subscript-child-union": function (a, b) {
                ...
                return (
                  a.expression.value.forEach(function (a) {
                    var d = { operation: "subscript", scope: "child", expression: a.expression },
                      e = this.resolve(d),
                      f = e(d, b);
                    f && (c = c.concat(f));
                  }, this),
            ...
            (i.prototype._vivify = function (a, b, c) {
              ...
              var f = this.parser.parse(b).map(function (a) {
                ...
                g = function (b, c) {
                  var e = b.pop(),
                    f = d.value(a, b);
                  f || (g(b.concat(), "string" == typeof e ? {} : []), (f = d.value(a, b))),
                    (f[e] = c);
                };
              ...
              if (Array.isArray(a) && "string" == typeof a[0]) {
                ...
                return (
                  a.forEach(function (a, c) {
                    if ("$" != a || 0 !== c)
                      if ("string" == typeof a && a.match("^" + f.identifier + "$"))
                        b.push({
                          operation: "member",
                          scope: "child",
        ...
        function (a, b, c) {
          ...
          b.exports = function (a, b, c, e) {
            ...
            if (
              ...
              return [];
            if (e < 0 && b <= c) return [];
            for (var g = [], h = b; h != c && !((e < 0 && h <= c) || (e > 0 && h >= c)); h += e)
              g.push(a[h]);
            return g;
          };
        },
          ...
          (function (a) {
            ...
            (c.resolve = function () {
              ...
              (c.basename = function (a, b) {
                var c = d(a);
                return (
                  b && c.substr(-1 * b.length) === b && (c = c.substr(0, c.length - b.length)), c
                );
              }),
              (c.extname = function (a) {
                ...
                return -1 === b || -1 === d || 0 === f || (1 === f && b === d - 1 && b === c + 1)
                  ? ""
                  : a.slice(b, d);
              });
            var f =
