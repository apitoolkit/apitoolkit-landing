  ...
  <section class="space-y-28 !mt-32">
        ...
        <div class="flex-1 space-y-8">
          <div class="flex items-end">
            ...
            <div class="hidden group-has-[.ft-logs:checked]/ft:block space-y-3 flex-1">
              ...
              <a href="features/api-logs-and-metrics/" class="block underline underline-offset-2 text-textBrand">Learn more</a>
            </div>
            <!-- end Logs -->
            ...
            <div class="hidden group-has-[.ft-errors:checked]/ft:block space-y-3 flex-1">
              ...
              <a href="/features/error-tracking/" class="block underline underline-offset-2 text-textBrand">Learn more</a>
            </div>
            ...
            <div class="hidden group-has-[.ft-monitors:checked]/ft:block space-y-3 flex-1">
              ...
              <a href="/features/api-observability/" class="block underline underline-offset-2 text-textBrand">Learn more</a>
            </div>
            <!-- end Monitors -->
            <!-- Metrics -->
            <div class="hidden group-has-[.ft-metrics:checked]/ft:block space-y-3 flex-1">
              ...
              <a href="/features/api-analytics/" class="block underline underline-offset-2 text-textBrand">Learn more</a>
            </div>
            <!-- end Metrics -->
            <!-- API Catalog -->
            <div class="hidden group-has-[.ft-apis:checked]/ft:block space-y-3 flex-1">
              ...
              <a href="/docs/onboarding/" class="block underline underline-offset-2 text-textBrand">Learn more</a>
            </div>
            <!-- end API Catalog -->
            <!-- Change Detection -->
            <div class="hidden group-has-[.ft-change:checked]/ft:block space-y-3 flex-1">
              ...
              <a href="/features/api-management/" class="block underline underline-offset-2 text-textBrand">Learn more</a>
            </div>
    ...
    <div class="text-textWeak space-y-5 w-full flex flex-col items-center justify-center">
      <div class="max-w-7xl px-3 w-full space-y-5">
        ...
        <a href="/docs/sdks/" class="block text-textBrand underline underline-offset-2">View all integrations.</a>
      </div>
