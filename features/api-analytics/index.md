...
###### [*Gain Insights, Optimize Your Product*{.drop-shadow-md}]{.bg-amber-300 .px-2 .rounded-md}
...
![APIToolkit Dashboard image](./dashboard.png){ class="w-full  drop-shadow-lg border border-gray-200 rounded-md"}

{.space-y-3 .col-span-2}
::::
{#getPeakUnderstanding .leading-tight}
### Get a peak understanding on how your APIs affect your workflow 
...
::::
{.leading-tight}
### Context-Rich Data on your API Anomalies 
...
{.col-span-3}
![APItoolkit anomalies](./anomalies.jpg){class="w-full drop-shadow-lg border border-gray-200 rounded-md"}
:::
...
::::
{.leading-tight}
### Get to know which API your customers use most 
...
![](./realtime-logs.png){class="w-full  drop-shadow-lg border border-gray-200 rounded-md"}

{.space-y-3 .col-span-2}
::::
{.leading-tight}
### Performance Analytics for Product Quality 
