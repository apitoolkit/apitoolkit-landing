...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
    ...
    <span class="px-8 text-black dark:text-white">Get started with using APItoolkit in a few steps.</span>
    </a>
    ...
    <span class="px-8 text-black dark:text-white">Explore all APItoolkit features in detail.</span>
    </a>
    ...
    <span class="px-8 text-black dark:text-white">Learn how to integrate APItoolkit using any of our SDKs for different programming languages and frameworks.</span>
    </a>
    ...
    <span class="px-8 text-black dark:text-white">Explore APItoolkit's dashboard and learn how to navigate through all the available features and settings.</span>
    </a>
</div>
```
